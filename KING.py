...
def clear():
    os.system('clear')
logo =("""\x1b[1;97m 
\x1b[1;91m  _____            _    _ _____ 
\x1b[1;91m |  __ \     /\   | |  | |_   _|
\x1b[1;91m | |__) |   /  \  | |__| | | |  
\x1b[1;91m |  _  /   / /\ \ |  __  | | |  
\x1b[1;91m | | \ \  / ____ \| |  | |_| |_ 
\x1b[1;91m |_|  \_\/_/    \_\_|  |_|_____|        \033[1;96m 
\x1b[1;97m[*]----------------------------------------------
\033[1;37m[*] Author        : Hasnain-KinG
\033[1;37m[*] Github        : Hasnain-KinG
\033[1;37m[*] Status        : FREE
\033[1;37m[*] TEAM          : Termux Free cmd
\033[1;37m[*] UPDATE BY     :Hasnain-KinG
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r {GREEN}[KING] %sYOUR ACTIVE APPLICATION DETAILS :'%(GREEN))
...
def free(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32KING-,OK-😛]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|KING-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
